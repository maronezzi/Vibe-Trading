"""
backtest_v7b.py — Iteration 2: ADX_TREND for WIN, tuned VWAP for WDO.
"""
...
# Params — WIN uses ADX_TREND, WDO uses VWAP with baseline-compatible params
PARAMS = {
    "WIN": {
    ...
    "WDO": {
        ...
        "rsi_oversold": 30, "vwap_period": 20, "vwap_buy_threshold": 1.003,
        "vwap_sell_threshold": 0.997, "sl_atr_mult": 1.0, "trail_activate": 1.5,
...
def run():
    print("\n" + "═" * 100)
    print("  🧪 BACKTEST v7b — ITERATION 2 (ADX_TREND for WIN, Tuned VWAP for WDO)")
    print("  " + "─" * 96)
    print("  ✅ WIN: ADX_TREND — trend-following with ADX + EMA + DI")
    print("  ✅ WDO: VWAP with baseline-compatible params (period=20, trail=1.5/0.5)")
    print("═" * 100)

    combos = [
        ("WIN$", "M5", 500, "ADX_TREND", "WIN"),
        ("WIN$", "M15", 500, "ADX_TREND", "WIN"),
        ("WDO$", "M5", 500, "VWAP", "WDO"),
    ...
    if all_results:
        ...
        print("\n\n" + "═" * 100)
        print("  📋 RANKING GERAL — v7b (Iteration 2)")
        print("═" * 100)
        ...
        print("\n\n" + "═" * 100)
        print("  📈 COMPARAÇÃO v7b vs v6 BASELINE")
        print("═" * 100)
        ...
        print(f"\n{'Ativo':<10} {'TF':<4} {'v6 Ret%':>8} {'v7b Ret%':>8} {'Δ':>7}")
        print("─" * 50)
